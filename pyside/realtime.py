...
def start_client(game_id: str, on_update: Callable[[RealTimeGameState], None]) -> RealTimePollingClient:
    """
    Start a real-time polling client for the specified game.
    ...
    Returns:
        A real-time polling client instance
    """
